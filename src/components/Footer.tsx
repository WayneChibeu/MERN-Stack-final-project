...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Main Info */}
          <div>
            <h3 className="text-lg font-semibold mb-2 text-gray-800 dark:text-white">EduConnect</h3>
            ...
            <div className="flex space-x-6 mt-4">
              <a 
                ...
                className="text-gray-400 dark:text-gray-500 hover:text-[#0A66C2] dark:hover:text-[#0A66C2] transition-colors duration-200 group"
                aria-label="Visit Wayne Chibeu's LinkedIn Profile"
              >
                <div className="p-2 rounded-full group-hover:bg-gray-100 dark:group-hover:bg-gray-700 transition-colors duration-200">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors duration-200 group"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold mb-3 text-gray-800 dark:text-white uppercase tracking-wide">Quick Links</h3>
